...
Find here both, the sources of the official capire docs, as well as a curated collection of reference samples for the [_SAP Cloud Application Programming Model (CAP)_](https://cap.cloud.sap) maintained by the CAP team. 
